...
export const navItems: NavItem[] = [
  ...
  { label: 'Bank Settings', href: '/bank-rec/settings', icon: Scale, indent: true },
  { label: 'Reports', href: '/reports', icon: FileText },
  { label: 'Balance Sheet', href: '/reports/balance-sheet', icon: FileText, indent: true },
  { label: 'Activities (P&L)', href: '/reports/activities', icon: FileText, indent: true },
  { label: 'Cash Flows', href: '/reports/cash-flows', icon: FileText, indent: true },
  { label: 'Cash Position', href: '/reports/cash-position', icon: FileText, indent: true },
  { label: 'Deposit Register', href: '/reports/security-deposit-register', icon: FileText, indent: true },
