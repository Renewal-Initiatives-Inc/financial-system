export const seedAnnualRates = [
  ...
  { fiscalYear: 2025, configKey: 'fica_ss_wage_base', value: '176100.000000', notes: 'SSA announcement', updatedBy: 'system', sourceDocument: 'SSA COLA Fact Sheet 2025', sourceUrl: 'https://www.ssa.gov/news/en/cola/factsheets/2025.html', verifiedDate: '2024-10-15' },
  { fiscalYear: 2026, configKey: 'fica_ss_wage_base', value: '184500.000000', notes: 'SSA announcement Oct 2025', updatedBy: 'system', sourceDocument: 'SSA COLA Fact Sheet 2026', sourceUrl: 'https://www.ssa.gov/news/en/cola/factsheets/2026.html', verifiedDate: '2025-10-10' },
  ...
  { fiscalYear: 2026, configKey: 'vendor_1099_threshold', value: '2000.000000', notes: 'Per OBBBA (P.L. 119-21)', updatedBy: 'system', sourceDocument: 'One Big Beautiful Bill Act (P.L. 119-21) §112', sourceUrl: 'https://www.congress.gov/bill/119th-congress/house-bill/1', verifiedDate: '2025-08-15' },
  // MA state tax rate
  ...
  { fiscalYear: 2026, configKey: 'ma_surtax_threshold', value: '1107750.000000', notes: 'MA DOR Form 1-ES 2026', updatedBy: 'system', sourceDocument: 'MA DOR Form 1-ES (2026)', sourceUrl: 'https://www.mass.gov/doc/2026-form-1-es-estimated-tax-payment-vouchers-instructions-and-worksheets/download', verifiedDate: '2025-12-15' },
