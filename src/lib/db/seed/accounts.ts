...
export const seedAccounts: SeedAccount[] = [
  ...
  { code: '1100', name: 'Accounts Receivable', type: 'ASSET', subType: 'Receivable', normalBalance: 'DEBIT', isSystemLocked: true },
  { code: '1110', name: 'Grants Receivable', type: 'ASSET', subType: 'Receivable', normalBalance: 'DEBIT', isSystemLocked: true },
  { code: '1120', name: 'Pledges Receivable', type: 'ASSET', subType: 'Receivable', normalBalance: 'DEBIT', isSystemLocked: false },
  { code: '1200', name: 'Prepaid Expenses', type: 'ASSET', subType: 'Prepaid', normalBalance: 'DEBIT', isSystemLocked: true },
  ...
  { code: '1800', name: 'Accum. Depreciation - Lodging', type: 'ASSET', subType: 'Contra', normalBalance: 'CREDIT', isSystemLocked: true },
  { code: '1810', name: 'Accum. Depreciation - Barn', type: 'ASSET', subType: 'Contra', normalBalance: 'CREDIT', isSystemLocked: true },
  { code: '1820', name: 'Accum. Depreciation - Garage', type: 'ASSET', subType: 'Contra', normalBalance: 'CREDIT', isSystemLocked: true },
  { code: '1830', name: 'Accum. Depreciation - Equipment', type: 'ASSET', subType: 'Contra', normalBalance: 'CREDIT', isSystemLocked: false },
  ...
  { code: '4040', name: 'Vacancy Loss', type: 'REVENUE', subType: 'Contra', normalBalance: 'DEBIT', isSystemLocked: false },
  ...
  { code: '5600', name: 'Admin Operating Costs', type: 'EXPENSE', subType: 'Operating', normalBalance: 'DEBIT', isSystemLocked: false, form990Line: '24a' },
]
