...
export function FixedAssetsClient({
  ...
  const totalNBV = filtered.reduce((sum, a) => sum + Number(a.netBookValue), 0)
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => setCreateOpen(true)} data-testid="create-asset-btn">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatCurrency(totalAccumDepr)}</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
